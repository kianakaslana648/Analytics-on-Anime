...
#File4=open("1000POPInfo.txt","w",encoding='utf-8')
...
#i=225
for i in range(764,1000):
    print(i)
    templink=df1.loc[i,'Link']
    ...
    playerwriter1.writerow([df1.loc[i,'Name'],df1.loc[i,'Link'],temptype,tempepi,tempstat,tempaired,temppre,tempbroad,tempprod,templic,tempstud\
             ,tempsource,tempgenre,tempdur,temprating,tempscore,tempuser,temprank,temppop,tempmem,tempfav])