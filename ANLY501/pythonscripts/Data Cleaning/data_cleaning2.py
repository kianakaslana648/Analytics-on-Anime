...
File1=pd.read_csv("1000POPInfo.txt",encoding='utf-8',names=['Name','Link','Type','Episodes','Status','Aired','Premiered','Broadcast',\
...
df1_cleaned=df1.drop(columns=['Link','Episodes','Status','Broadcast','Producers','Licensors','Studios','Duration'])
...
#print(df1_cleaned['Rating'].value_counts())
...
df1_cleaned.to_csv('1000PopInfo_cleaned.txt',header=False,index=False)